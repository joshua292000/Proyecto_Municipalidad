...
public class FlowController {
    ...
    public void goView(String viewName, String location, String accion) {
        ...
        switch (location) {
            case "Center":
                ((VBox) (((StackPane) ((BorderPane) stage.getScene().getRoot()).getCenter()).getChildren().get(1))).getChildren().clear();
                ((VBox) (((StackPane) ((BorderPane) stage.getScene().getRoot()).getCenter()).getChildren().get(1))).getChildren().add(loader.getRoot());
                break;
            case "Top":
                break;
            case "Bottom":
